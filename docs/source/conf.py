...
# finance_overlook documentation build
...
from finance_overlook import __version__ as release

# -- Project information -----------------------------------------------------

project = "finance_overlook"
author = "Kedro"
...
htmlhelp_basename = "finance_overlookdoc"
...
latex_documents = [
    (
        master_doc,
        "finance_overlook.tex",
        "finance_overlook Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "finance_overlook",
        "Project finance_overlook codebase.",
        "Data-Science",
    )
]
