...
def main():
    ...
    inflation_url = "https://api.bcb.gov.br/dados/serie/bcdata.sgs.433/ultimos/30?formato=json"
    job_rates_url = "https://api.bcb.gov.br/dados/serie/bcdata.sgs.24369/ultimos/30?formato=json"
    interest_rates_url = "https://api.bcb.gov.br/dados/serie/bcdata.sgs.11/ultimos/30?formato=json"
    public_spending_url = "https://api.bcb.gov.br/dados/serie/bcdata.sgs.4426/ultimos/30?formato=json"
